...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko18', [
            'priority'    => 10,
            'title'       => esc_html__('Toko 18', 'justg'),
...
add_action('justg_header', 'justg_header_toko18');
function justg_header_toko18()
{
    require_once(get_stylesheet_directory() . '/inc/part-header.php');
}
add_action('justg_do_footer', 'justg_footer_toko18');
function justg_footer_toko18()
{
...
add_action('velocitytoko_product_loop', 'velocitytoko18_content_product', 30);
function velocitytoko18_content_product($post)
{
    if (is_singular('product')) :
        $class = 'col-6 mb-2';
    else :
